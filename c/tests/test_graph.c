...
int main(void) {
    ...
    /* Add edges: 0-1(10), 0-2(3), 1-3(5), 2-3(8), 3-4(2) */
    ...
    /* Verify num_vertices == 5 */
    ASSERT(g->num_vertices == 5, "num_vertices should remain 5");
    PASS("num_vertices == 5");

    /* Test block_vertex(2): verify vertex_blocked[2]==true */
    ...
    /* Test unblock_vertex(2): verify vertex_blocked[2]==false */
    ...
    /* Test block_edge(0,1): find edge in edge_list, verify blocked==true */
